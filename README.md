...
Before running the software, you need to set up the environment. Here’s how:
...
1. Locate the application file that you downloaded.
2. Double-click the file to run it.
3. Follow the on-screen instructions to upload your video and start the motion reconstruction process.
